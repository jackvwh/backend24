//package saxxen.security.for_security_tests;
//
...
//
//    public ControllerToTestRoles(UserService userService) {
...
//        return new TestResponse(userService.getUser(principal.getName()).getUserName(),"Admin");
//    }
//    @PreAuthorize("hasAuthority('USER')")
//    @GetMapping("/user")
//    public TestResponse getUserUser(Principal principal) {
//        return new TestResponse(userService.getUser(principal.getName()).getUserName(),"User");
//    }
//
//    @PreAuthorize("hasAuthority('USER') or hasAuthority('ADMIN')")
//    @GetMapping("/useradmin")
//    public TestResponse getUserOrAdminUser(Principal principal) {
//        return new TestResponse(userService.getUser(principal.getName()).getUserName(),"User and/or Amin");
//    }
//
//    @GetMapping("/authenticated")
//    public TestResponse getAuthenticatedUser(Principal principal) {
//        return new TestResponse(userService.getUser(principal.getName()).getUserName(),"Authenticated user");
//    }
//}
